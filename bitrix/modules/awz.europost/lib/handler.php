...
class Handler extends \Bitrix\Sale\Delivery\Services\Base {
    ...
    {
        return Loc::getMessage('AWZ_EUROPOST_HANDLER_NAME');
    }

    public static function getClassDescription()
    {
        return Loc::getMessage('AWZ_EUROPOST_HANDLER_DESC');
    }
    ...
    {
        return array(
            'Awz\Europost\Profiles\Pickup',
            //'Awz\Europost\Profiles\Standart',
        );
    }
    ...
    {
        throw new \Bitrix\Main\SystemException(Loc::getMessage('AWZ_EUROPOST_HANDLER_NOPROFILE'));
    }

    public static function getLogo(){

        $arFile = \CFile::MakeFileArray('/bitrix/images/'.self::MODULE_ID.'/logo.png');
