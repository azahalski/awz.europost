...
1) Передите на страницу решения в маркетплейс 1с-Битрикс [ссылка](https://marketplace.1c-bitrix.ru/solutions/awz.europost/)
...
2) Введите код модуля awz.europost
...
1) Скачайте необходимую версию модуля с github, например, со страницы [releases](https://github.com/azahalski/awz.europost/releases)
2) Распакуйте архив
3) Загрузите модуль
   
**Если установка в UTF-8 версии**

Скопируйте папку с распакованного архива bitrix\modules\awz.europost в папку \bitrix\modules\ вашего сайта
...
- Переименовываем папку из .last_version в awz.europost
- Копируем нашу папку dist\awz.europost в папку \bitrix\modules\ вашего сайта
4) Проверяем или все верно
- Вместо awz.module на изображении Ваша папка будет с названием `awz.europost`
...
6) Выбираем модуль с кодом awz.europost и нажимаем установить
