...
**version 1.2.8**    
- добавлена дополнительная проверка прав на заказ у пользователя при изменении заказа; - добавлен обработчик для возможности подмены финального списка ПВЗ.    

**version 1.2.7**    
- изменена версия зависимости jquery.    
